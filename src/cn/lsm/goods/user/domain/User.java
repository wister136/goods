package cn.lsm.goods.user.domain;
...
/*
 * 属性哪里来？
 * 1.t_user表：因为我们需要把t_user表查询出的数据封装到User中 
 * 2.该模块所有表单：因为我们需要把表单数据封装到User中
 */
public class User {
	//对应的数据库表
	...
	private boolean status;// 状态，true表示已将激活，或者未激活
	private String activationCode;// 激活码，他是唯一的
